...
By sending a POST request to this endpoint with specific queries and variables, the extension retrieves exactly what it needs. 

Some of the specific GraphQL queries used include:
